	...
	<div class="container">
		...
		<div>
			<label for="username">아이디</label> <input class="form-control"
				type="text" id="username" name="username" value="${p.user.username}"
				readonly="readonly">
		</div>
		<br />
		<div>
		...
		<div>
			<label for="email">이메일</label> <input class="form-control"
				type="text" id="email" name="email" value="${p.user.email}">
		</div>
		<br />
		<div>
			<label for="email">이름</label> <input class="form-control" type="text"
				id="name" name="name" value="${p.user.name}" readonly="readonly">
		</div>
		<br />
		<div>
			<label for="birth">생년월일</label> <input class="form-control"
				type="text" id="birth" name="birth" value="${p.user.birth}"
				readonly="readonly">
		</div>
		<br />
		<div>
			<label for="age">나이</label> <input class="form-control" type="text"
				id="age" name="age" value="${p.user.age}" readonly="readonly">
		</div>
		<br />
		<div>
			<label for="phone">휴대전화</label> <input class="form-control"
				type="text" id="phone" name="phone" value="${p.user.phone}">
		</div>
		<br />
		<div>
			<label>주소</label>
			<div class="row">
				<div class="col">
					<input class="form-control" type="text" id="zipcode" name="zipcode"
						placeholder="우편번호" value="${p.user.address.zipcode}"
						readonly="readonly">
				</div>
				<div class="col-2">
			...
			<div class="row">
				<div class="col">
					<input class="form-control" type="text" id="address1"
						name="address1" value="${p.user.address.address1}"
						readonly="readonly">
				</div>
				...
				<div class="col">
					<input class="form-control" type="text" id="address2"
						name="address2" value="${p.user.address.address2}">
				</div>
			</div>
		</div>
		<br />
		<c:choose>
			<c:when test="${p.user.gender == 'man'}">
				<div>
